...
public:
...
#ifndef LEGACY_BACKEND
    static_assert(GT_TEST_EQ - GT_EQ - S == EQ, "bad relop");
    static_assert(GT_TEST_NE - GT_EQ - S == NE, "bad relop");
#endif
    ...
    static GenCondition FromIntegralRelop(genTreeOps oper, bool isUnsigned)
    {
        ...
        {
#ifndef LEGACY_BACKEND
            assert((oper == GT_TEST_EQ) || (oper == GT_TEST_NE));
#endif
            code -= S;
        }
        else if ((code > NE) && isUnsigned)
        {
            code |= Unsigned;
        }
