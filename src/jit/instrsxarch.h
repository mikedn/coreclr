...
INST3(cmovp  , "cmovp"        , 0, IUM_WR, 1, 0, BAD_CODE, BAD_CODE, 0x0F004A)
INST3(cmovnp , "cmovnp"       , 0, IUM_WR, 1, 0, BAD_CODE, BAD_CODE, 0x0F004B)
...
INST1(setp   , "setp"         , 0, IUM_WR, 1, 0, 0x0F009A)
INST1(setnp  , "setnp"        , 0, IUM_WR, 1, 0, 0x0F009B)
...
INST0(jp     , "jp"           , 0, IUM_RD, 1, 0, 0x00007A)
INST0(jnp    , "jnp"          , 0, IUM_RD, 1, 0, 0x00007B)
...
INST0(l_jp   , "jp"           , 0, IUM_RD, 1, 0, 0x008A0F)
INST0(l_jnp  , "jnp"          , 0, IUM_RD, 1, 0, 0x008B0F)
